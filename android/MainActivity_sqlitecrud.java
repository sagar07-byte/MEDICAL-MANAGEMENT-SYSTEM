package com.mcdevelopers.sqlitecrud;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Rollno=(EditText)findViewById(R.id.editText_USN);
    ...
    public void onClick(View view)
    {
        ...
        if(view==Delete)
        {
            ...
            try (Cursor c = db.rawQuery("SELECT * FROM student WHERE rollno='" + Rollno.getText() + "'", null)) {
                if (c.moveToFirst()) {
