...
Begin VB.Form CUS_ORD_DTL 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo3 
         ...
         EndProperty
         Height          =   555
         ItemData        =   "CUS_ORD_DTL.frx":0000
         Left            =   15960
         List            =   "CUS_ORD_DTL.frx":000A
      ...
      Begin VB.ComboBox Combo2 
         ...
         EndProperty
         Height          =   555
         ItemData        =   "CUS_ORD_DTL.frx":001C
         Left            =   3600
         List            =   "CUS_ORD_DTL.frx":001E
         Style           =   2  'Dropdown List
         TabIndex        =   5
         Top             =   3480
         Width           =   2775
      ...
      Begin MSAdodcLib.Adodc Adodc1 
         ...
         UserName        =   ""
         Password        =   ""
         RecordSource    =   "select * from cus_ord_dtl order by ord_id"
         Caption         =   "Adodc1"
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
      ...
      Begin VB.ComboBox Combo1 
         ...
         EndProperty
         Height          =   555
         ItemData        =   "CUS_ORD_DTL.frx":0035
         Left            =   3600
         List            =   "CUS_ORD_DTL.frx":0037
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   2280
         Width           =   2775
...
path
S = "select c_nm from cus_dtl where c_id='" + Trim(Combo1.Text) + "'"
Set R = CC.Execute(S)
Text2.Text = R.Fields("c_nm")
End If
If Command4.Enabled = True Then
Adodc1.CommandType = adCmdUnknown
Adodc1.RecordSource = "select * from cus_ord_dtl where c_id='" & Combo1.Text & "'"
Adodc1.Refresh
...
Combo1.SetFocus
path
S = "select max(to_number(substr(ord_id,4,length(ord_id)))) from cus_ord_dtl"
Set R = CC.Execute(S)
code = "ORD"
...
Text15.Text = ""
Adodc1.CommandType = adCmdUnknown
Adodc1.RecordSource = "SELECT *  FROM cus_ord_dtl ORDER BY ORD_ID"
Adodc1.Refresh
...
path
S = "select TOT_amt from cus_ord_dtl where ord_id='" + Text1.Text + "'"
Set R = CC.Execute(S)
While R.EOF = False
amt = amt + R.Fields(0)
R.MoveNext
...
Text13.Text = ra
path
T = "insert into temp_CUS_ord_dtl values('" + Text1.Text + "','" + Format(DTP1.Value, "dd-mmm-yyyy ") + "','" + Combo1.Text + "','" + Text2.Text + "'," + Text11.Text + "," + Text12.Text + "," + Text13.Text + ")"
Set R2 = CC.Execute(T)
MsgBox "record saved"
...
Else
path
T = "select rem_qty from stk_dtl where p_id='" & Trim(Combo2.Text) & "'"
Set R2 = CC.Execute(T)
Dim q1, r1 As Integer
r1 = R2.Fields("rem_qty")
q1 = Val(Text6.Text)
If (q1 < r1) Then
S = "insert into CUS_ord_dtl values('" + Text1.Text + "','" + Format(DTP1.Value, "dd-mmm-yyyy") + "','" + Combo1.Text + "','" + Text2.Text + "','" + Combo2.Text + "','" + Text3.Text + "','" + Text4.Text + "'," + Text5.Text + "," + Text6.Text + ",'" + Combo3.Text + "'," + Text11.Text + "," + Text12.Text + "," + Text13.Text + "," + Text7.Text + "," + Text8.Text + "," + Text9.Text + "," + Text10.Text + ",'" + CHQ_DTL.Text1.Text + "','" + CHQ_DTL.Text2.Text + "','" + CHQ_DTL.Text3.Text + "','" + CHQ_DTL.Text4.Text + "','" + CHQ_DTL.Text5.Text + "','" + CHQ_DTL.Text6.Text + "')"
Set R = CC.Execute(S)
Text16.Text = Val(Text11.Text)
Unload CHQ_DTL
CUS_ORD_DTL.WindowState = 2 - MAXIMIZED
MsgBox "RECORD SAVED"
DTP1.Enabled = False
Combo1.Enabled = False
Combo2.Enabled = False
...
Command3.Enabled = True
Else
MsgBox "you can't take order because stock is underflowing ! ", vbCritical, "Message"
Command1.Enabled = False
Command2.Enabled = True
Exit Sub
End If
...
Command8.SetFocus
Else
    T = "insert into temp_CUS_ord_dtl values('" + Text1.Text + "','" + Format(DTP1.Value, "dd-mmm-yyyy ") + "','" + Combo1.Text + "','" + Text2.Text + "'," + Text16.Text + "," + Text12.Text + "," + Text13.Text + ")"
    Set R2 = CC.Execute(T)
End If
End If
End If
...
If Text1.Text <> "" Then
S = "delete from cus_ord_dtl where ord_id='" & Text1.Text & "'"
Set R = CC.Execute(S)
Adodc1.Refresh
...
Else
If Text1.Text = "" Then
S = "delete from cus_ord_dtl where ord_dt='" & Format(DTP1.Value, "dd-mmm-yyyy") & "'"
Set R = CC.Execute(S)
Adodc1.Refresh
MsgBox "record deleted"
Exit Sub
Else
If Combo1.Text <> "" Then
S = "delete from cus_ord_dtl where c_id='" & Combo1.Text & "'"
Set R = CC.Execute(S)
Adodc1.Refresh
MsgBox "record deleted"
Exit Sub
...
Combo1.Enabled = True
Combo2.Enabled = False
MsgBox "Enter  ORDER_ID or ORDER_DATE or CUSTOMER_ID or CUSTOMER_NAME for Searching", vbInformation, "MESSAGE"
Text1.SetFocus
End Sub
Private Sub Command5_Click()
Command5.Enabled = False
path
S = "update cus_ord_dtl set ord_dt='" + Format(DTP1.Value, "dd-mmm-yyyy") + "',c_id='" + Combo1.Text + "',c_nm='" + Text2.Text + "',p_id='" + Combo2.Text + "',p_nm='" + Text3.Text + "',pack='" + Text4.Text + "',mrp=" + Text5.Text + ",qty=" + Text6.Text + ",mod_ptm='" + Combo3.Text + "',tot_amt=" + Text11.Text + ",adv_prc=" + Text12.Text + ",rem_amt=" + Text13.Text + ",RT=" + Text7.Text + ",VAT=" + Text8.Text + ",DISC=" + Text9.Text + " where ord_id='" + Text1.Text + "'"
Set R = CC.Execute(S)
...
Combo3.Text = DataGrid1.Columns(9).Text
Text11.Text = DataGrid1.Columns(10).Text
Text12.Text = DataGrid1.Columns(11).Text
Text13.Text = DataGrid1.Columns(12).Text
Text7.Text = DataGrid1.Columns(13).Text
Text8.Text = DataGrid1.Columns(14).Text
Text9.Text = DataGrid1.Columns(15).Text
Text10.Text = DataGrid1.Columns(16).Text
...
If Command4.Enabled = True Then
Adodc1.CommandType = adCmdUnknown
Adodc1.RecordSource = "select * from cus_ord_dtl where ord_dt='" & Format(DTP1.Value, "dd-mmm-yyyy") & "'"
Adodc1.Refresh
If Adodc1.Recordset.RecordCount = 0 Then
MsgBox " Record Not FOund ! ", vbCritical, "MESSAGE"
Exit Sub
...
Adodc1.CommandType = adCmdUnknown
Adodc1.RecordSource = "select * from cus_ord_dtl where ord_id='" + Text1.Text + "'"
Adodc1.Refresh
Text10.Visible = True
Text11.Visible = True
If Adodc1.Recordset.RecordCount = 0 Then
...
DataEnvironment1.Command5 Text1.Text
DataReport5.Show
Command10.Enabled = True
End If
End If
