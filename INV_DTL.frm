...
Begin VB.Form INV_DTL 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo4 
         ...
         EndProperty
         Height          =   555
         ItemData        =   "INV_DTL.frx":0000
         Left            =   11760
         List            =   "INV_DTL.frx":000A
         Locked          =   -1  'True
      ...
      Begin MSAdodcLib.Adodc Adodc1 
         ...
         UserName        =   ""
         Password        =   ""
         RecordSource    =   "select * from inv_dtl order by inv_id"
         Caption         =   "Adodc1"
...
path
S = "select ord_Dt,C_id from CUS_ord_Dtl where ord_id='" + Trim(Combo1.Text) + "' "
Set R = CC.Execute(S)
Combo2.AddItem R.Fields("C_id")
DTP1.Value = R.Fields("ord_dt")
path
T = "SELECT P_ID FROM CUS_ORD_dTL WHERE ORD_ID='" + Trim(Combo1.Text) + "'"
Set R2 = CC.Execute(T)
While R2.EOF = False
...
Adodc1.RecordSource = "select * from INV_dtl where ORD_id='" & Combo1.Text & "'"
Adodc1.Refresh
...
path
S = "select * from CUS_ORD_dtl where p_id='" + Trim(Combo3.Text) + "'"
Set R = CC.Execute(S)
...
If Command1.Enabled = False Then
path
S = "select C_nm from CUS_dtl where  C_id='" + Trim(Combo2.Text) + "'"
Set R = CC.Execute(S)
Text4.Text = R.Fields("C_nm")
path
S = "select C_add from CUS_dtl where C_id='" + Trim(Combo2.Text) + "'"
Set R = CC.Execute(S)
Text3.Text = R.Fields("C_add")
End If
If Command3.Enabled = True Then
Adodc1.CommandType = adCmdUnknown
Adodc1.RecordSource = "select * from INV_dtl where C_id='" & Combo2.Text & "'"
Adodc1.Refresh
Set DataGrid1.DataSource = Adodc1
Command3.Enabled = True
If Adodc1.Recordset.RecordCount = 0 Then
...
Combo1.SetFocus
path
S = "select max(to_number(substr(inv_id,4,length(inv_id)))) from INV_dtl"
Set R = CC.Execute(S)
code = "INV"
...
Text22.Text = ""
Adodc1.CommandType = adCmdUnknown
Adodc1.RecordSource = "SELECT *  FROM inv_dtl ORDER BY inv_ID"
Adodc1.Refresh
...
S = "select tot_amt,rem_amt,adv_prc from temp_cus_ord_dtl where ord_id='" & Trim(Combo1.Text) & "'"
Set R = CC.Execute(S)
...
U = "insert into temp_INV_Dtl values('" & Text1.Text & "'," & tot_amt & ")"
Set R3 = CC.Execute(U)
Exit Sub
Else
...
Else
MsgBox "YOUR PRODUCT IS EXPIRED", vbCritical, "MESSAGE"
End If
If MsgBox("do you want to continue for Multiple SALE", vbYesNo, "message") = vbYes Then
MsgBox "Click Add More Button ", vbInformation, "MESSAGE"
Command7.SetFocus
Command1.Enabled = False
Command2.Enabled = True
Else
U = "insert into temp_INV_Dtl values('" & Text1.Text & "'," & TOT_AM & ")"
Set R3 = CC.Execute(U)
End If
End If
End If
...
Combo2.Enabled = True
Text2.Enabled = False
MsgBox "Enter  Invoice_Id OR Order_Id OR Sale_Date for searching", vbInformation, "MESSAGE"
Text1.SetFocus
End Sub
...
INV_DTL.WindowState = 2 - MAXIMIZED
...
If Command3.Enabled = True Then
Adodc1.CommandType = adCmdUnknown
Adodc1.RecordSource = "select * from INV_dtl where SL_DT='" & Format(DTP2.Value, "DD-MMM-YYYY") & "'"
Adodc1.Refresh
Set DataGrid1.DataSource = Adodc1
Command3.Enabled = True
If Adodc1.Recordset.RecordCount = 0 Then
...
DTP4.Value = Date
path
S = "select distinct(ORD_id) from CUS_ORD_dtl order by ord_id "
Set R = CC.Execute(S)
While R.EOF = False
...
Adodc1.CommandType = adCmdUnknown
Adodc1.RecordSource = "select * from INV_dtl where inv_id='" + Text1.Text + "'"
Adodc1.Refresh
If Adodc1.Recordset.RecordCount = 0 Then
...
DataEnvironment1.Command7 Text1.Text
Set R = New ADODB.Recordset
S = "select net_prc from temp_INV_dtl where inv_id='" & Text1.Text & "'"
Set R = CC.Execute(S)
DataReport7.Sections("section5").Controls("label23").Caption = R.Fields(0)
T = "SELECT C_NM,C_ADD,MOD_PTM,INV_ID FROM INV_dTL WHERE INV_ID='" & Text1.Text & "'"
Set R2 = CC.Execute(T)
DataReport7.Sections("section2").Controls("label3").Caption = R2.Fields("C_NM")
DataReport7.Sections("section2").Controls("label5").Caption = R2.Fields("C_ADD")
DataReport7.Sections("section2").Controls("label6").Caption = R2.Fields("MOD_PTM")
DataReport7.Sections("section2").Controls("label9").Caption = R2.Fields("INV_ID")
DataReport7.Show
...
If Val(Text19.Text) <= O Then
MsgBox "YOU CAN'T SELL", vbInformation, "ERROR"
End If
End Sub
